  ...
  for featuretype in configFiles.keys():
    ...
    for lang in languages:
      for degreeSet in subsets:
        ...
        #make a new directory for feature files for a given a language and degree
        ...
        hcopycommand = '\"C:\\Program Files\\HTK-3.4.1\\htk\\bin.win32\\HCopy.exe\" -C ' + configfilename + ' -S ' + wav_feature_pair_file
        print hcopycommand
